    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TariffSchemas", x => x.TariffId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TariffRangeId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StartKm = table.Column<decimal>(type: "decimal(4,1)", precision: 4, scale: 1, nullable: false),
                    EndKm = table.Column<decimal>(type: "decimal(4,1)", precision: 4, scale: 1, nullable: false),
                    PricePerKm = table.Column<decimal>(type: "decimal(2,2)", precision: 2, scale: 2, nullable: false),
                    SeatClass = table.Column<int>(type: "int", nullable: false),
                    TariffSchemaTariffId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.TariffSchemaTariffId,
                        principalTable: "TariffSchemas",
                        principalColumn: "TariffId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RouteId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    StationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DistanceFromMain = table.Column<decimal>(type: "decimal(5,1)", precision: 5, scale: 1, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SeatReservationDetails", x => new { x.ReservationId, x.SeatId });
                    table.ForeignKey(
                        name: "FK_SeatReservationDetails_Reservations_ReservationId",
                        column: x => x.ReservationId,
                        principalTable: "Reservations",
                        principalColumn: "ReservationId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SeatReservationDetails_Seats_SeatId",
                        column: x => x.SeatId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SeatReservationDetails_SeatId",
                table: "SeatReservationDetails",
                column: "SeatId");
