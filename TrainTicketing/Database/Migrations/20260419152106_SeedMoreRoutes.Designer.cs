...
namespace TrainTicketing.Database.Migrations
{
    ...
    [Migration("20260419152106_SeedMoreRoutes")]
    partial class SeedMoreRoutes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TrainTicketing.DomainModel.Entities.DepartureDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TrainTicketing.DomainModel.Entities.Route", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            RouteId = new Guid("6cf15bf2-db1a-4874-b2c7-9be7110eaaf0"),
                            ImagePath = "https://trainticketing.blob.core.windows.net/trainticketingimages/ruta_Bucuresti-Brasov.png",
                            MainTerminalId = new Guid("8f1fd997-1261-450b-912f-8c90650e49d5"),
                            RouteName = "Ruta6cf15bf2-db1a-4874",
                            TariffSchemaId = 1,
                            TotalDistance = 169.0m
                        },
                        new
                        {
                            RouteId = new Guid("4b13c88b-9c49-4177-91c9-76648b8c8231"),
                            ImagePath = "https://trainticketing.blob.core.windows.net/trainticketingimages/ruta_Bucuresti-Brasov.png",
                            MainTerminalId = new Guid("8f1fd997-1261-450b-912f-8c90650e49d5"),
                            RouteName = "Ruta4b13c88b-9c49-4177",
                            TariffSchemaId = 1,
                            TotalDistance = 169.0m
                        },
                        new
                        {
                            RouteId = new Guid("e19ada88-c110-4f0f-96ce-ef1ce0bd1738"),
                            ImagePath = "https://trainticketing.blob.core.windows.net/trainticketingimages/ruta_Bucuresti-Brasov.png",
                            MainTerminalId = new Guid("8f1fd997-1261-450b-912f-8c90650e49d5"),
                            RouteName = "Rutae19ada88-c110-4f0f",
                            TariffSchemaId = 1,
                            TotalDistance = 169.0m
                        },
                        new
                        {
                            RouteId = new Guid("7756bfd1-4020-4193-a342-562d20509df8"),
                            ImagePath = "https://trainticketing.blob.core.windows.net/trainticketingimages/ruta_Bucuresti-Brasov.png",
                            MainTerminalId = new Guid("8f1fd997-1261-450b-912f-8c90650e49d5"),
                            RouteName = "Ruta7756bfd1-4020-4193",
                            TariffSchemaId = 1,
                            TotalDistance = 169.0m
                        },
                        new
                        {
                            RouteId = new Guid("3757cae8-6223-4c2c-b23c-d514173c449b"),
                            ImagePath = "https://trainticketing.blob.core.windows.net/trainticketingimages/ruta_Bucuresti-Brasov.png",
                            MainTerminalId = new Guid("8f1fd997-1261-450b-912f-8c90650e49d5"),
                            RouteName = "Ruta3757cae8-6223-4c2c",
                            TariffSchemaId = 1,
                            TotalDistance = 169.0m
                        },
                        new
                        {
                            RouteId = new Guid("1e55a13b-1ce5-4370-bf93-8851415ddedb"),
                            ImagePath = "https://trainticketing.blob.core.windows.net/trainticketingimages/ruta_Bucuresti-Brasov.png",
                            MainTerminalId = new Guid("8f1fd997-1261-450b-912f-8c90650e49d5"),
                            RouteName = "Ruta1e55a13b-1ce5-4370",
                            TariffSchemaId = 1,
                            TotalDistance = 169.0m
                        });
                });
            ...
            modelBuilder.Entity("TrainTicketing.DomainModel.Entities.Train", b =>
                {
                    b.Property<Guid>("TrainId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TrainTicketing.DomainModel.Entities.DepartureDetail", b =>
                {
                    b.HasOne("TrainTicketing.DomainModel.Entities.DepartureSchedule", "Departure")
                        .WithMany("DepartureDetails")
                        .HasForeignKey("DepartureId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TrainTicketing.DomainModel.Entities.RouteDetail", "RouteDetail")
            ...
            modelBuilder.Entity("TrainTicketing.DomainModel.Entities.DepartureSchedule", b =>
                {
                    b.HasOne("TrainTicketing.DomainModel.Entities.Route", "Route")
                        .WithMany("Departures")
                        .HasForeignKey("RouteId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TrainTicketing.DomainModel.Entities.Train", "Train")
                        .WithMany()
            ...
            modelBuilder.Entity("TrainTicketing.DomainModel.Entities.RouteDetail", b =>
                {
                    ...
                    b.HasOne("TrainTicketing.DomainModel.Entities.Station", "Station")
                        .WithMany()
